...
async function loadProfile(user) {
  try {
    ...
    // التقويم الأسبوعي
    const calContainer = document.getElementById('weeklyCalendarContainer');
    if (calContainer && typeof renderWeeklyCalendar !== 'undefined') {
      renderWeeklyCalendar(user.uid, calContainer);
    }
